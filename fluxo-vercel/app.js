...
<section id="dashboard" class="section">
  ...
  <div class="row"><div class="card"><h3>Gastos por categoria</h3><div id="bars" class="bars"></div></div><div class="card"><h3>Reservas das contas fixas</h3><div id="reserveSummary"></div></div></div>
...
<section id="contas" class="section"><div class="top"><div class="title"><h1>Contas fixas</h1><p>Vencimentos e reservas quinzenais no mesmo lugar.</p></div><button class="primary" onclick="openFixedModal()">+ Nova conta</button></div><div class="notice"><b>Reserva integrada à conta:</b> para cada conta fixa, o Fluxo mostra o valor total, quanto você já separou no mês e quanto ainda falta. Por padrão, novas contas já vêm com divisão 50% + 50% ativada, e você pode desligar quando não precisar.</div><div id="fixedTable" class="fixed-account-list"></div></section>`}
...
window.openFixedModal=()=>{editingFixedId=null;fixedModalTitle.textContent='Nova conta fixa';fd.value='';fv.value='';fmonth.value='';frule.value='calendar_day';fday.value='';fbday.value='';freserve.checked=true;fsplit.value=50;toggleFixedRuleFields();toggleFixedReserveFields();openModal('mFixed')};
